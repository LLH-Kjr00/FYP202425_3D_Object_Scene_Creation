...
class ModelDenoiser:
    ...
    def denoise_all_manual(self, input_path, base_name):
        ...
        process_path = self.remove_isolated_denoiser.denoise(input_path, f"denoiser/Output/Intermediate/RmvIsoVertice/{base_name}_removedIsolated.obj") 
        ...
        print("")
        process_path = self.hole_filling_denoiser.denoise(process_path, f"denoiser/Output/Intermediate/FillingHoles/{base_name}_holeFilled.obj", target_fillLv)
        ...
        while True:
            try:
                ...
                print("[denoise_all] - Invalid input! Please enter a valid integer.")
        print("")
        process_path = self.mesh_smoothing_denoiser.denoise(process_path, f"denoiser/Output/Intermediate/MeshSmoothing/{base_name}_smoothen.obj", target_smoothness) 
        ...
        print("")      
        process_path = self.decimate_mesh_denoiser.denoise(process_path, f"denoiser/Output/Finished/{base_name}_finished.obj", target_decimation)
